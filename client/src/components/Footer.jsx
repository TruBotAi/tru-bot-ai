function Footer() {
  return (
    <>
      <footer className='bg-[#263238] mt-10'>
        <div className='text-white  '>
          <div className='logo pl-5 z-1 p-4 '>
            <div className='font-bold text-2xl flex items-center gap-1'>
              <span>
                <svg fill='#fff' height='45' viewBox='0 0 164 125' width='44'>
                  <path
          ...
          <hr />
          <div className='links flex justify-between items-start p-4 px-9'>
            <div className='link'>
              <h2 className='uppercase font-bold text-xl mb-8'>Platform</h2>
            ...
            <div className='link'>
              <h2 className='uppercase font-bold text-xl mb-8'>Solutions</h2>
              <ul className='flex flex-col gap-5'>
                <li>BY USE CASE</li>
                <li>Lead Generation</li>
                <li>Customer Supoprt </li>
                <li>Appointment Booking</li>
                <li></li>
              </ul>
            </div>
            <div className='link'>
              <h2 className='uppercase font-bold text-xl mb-8'>Company</h2>
              <ul className='flex flex-col gap-5'>
                <li>About Us</li>
                <li>Customers</li>
            ...
            <div className='link'>
              <h2 className='uppercase font-bold text-xl mb-8'>Resources</h2>
              <ul className='flex flex-col gap-5'>
                <li>Blogs</li>
                <li>Customers Story</li>
                <li>Comparisons</li>
                <li>Help Docs</li>
                <li>Videos</li>
